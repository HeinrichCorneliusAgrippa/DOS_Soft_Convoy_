...
GODOT_SCENES = {
    ...
    # Combined convoy: one Godot world with a real agent-driven lead bot (carries
    # the circle-grid marker) and the follower bot behind it. Launched via
    # `launch.py --convoy`, which runs BOTH virtual servers against this scene.
    'convoy': 'res://scenes/maps/convoy.tscn',
}
